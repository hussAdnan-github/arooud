...
export default function Offer({ data }) {
  ...
  return (
    <div className="offer  container mx-auto ">
      <div className=" relative bottom-36 w-full bg-white rounded-xl   dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 pb-10">
        ...
        <div className="flex flex-col items-start justify-between md:flex-row md:max-w-screen-xl  ">
          <div className="flex flex-col items-end mt-6 mx-0 md:mx-10 gap-6 w-full md:w-2/3">
            ...
            <h1 className="text-2xl md:mt-2 text-center md:text-end font-medium	md:text-5xl text-black dark:text-white">
              {data.name_ar}
            </h1>
            <h1 className="text-2xl md:text-3xl px-3 md:px-0 font-light	 text-center md:text-end ps-0 md:ps-20 text-black dark:text-white">
              {data.description_ar}
            </h1>
            <div className="flex md:flex-row flex-col-reverse gap-6 mb-10 md:mb-0 md:gap-10 mt-4 items-center w-full md:w-auto">
              <div className="flex items-end md:items-center gap-2 md:justify-normal justify-center ">
                <div className="text-end">
                  <p className="font-medium text-sm dark:text-[#C8C9CC]">
                    صلاحية العرض
                  </p>
              ...
              <div className="flex gap-4 flex-col-reverse md:flex-row items-center md:items-center">
                <p className="me-6 text-xl md:text-4xl line-through text-[#C8C9CC]">
                  5999{" "}
                </p>
                <p className="text-xl dark:text-[#C8C9CC]">
                  رس{" "}
                  <span className="font-normal text-[10px] dark:text-[#C8C9CC]">
                    ( شامل الضريبة )
                  </span>
                </p>
                <div className="flex flex-col items-center">
                  <p className="text-5xl md:text-6xl font-medium dark:text-white">
                    457899
                  </p>
          ...
          <div className="bg-[#F4F4F4] overflow-hidden m-0 md:m-6 p-0 md:p-4 w-full md:w-[400px] h-80 md:h-[425px] rounded-xl flex items-center justify-center">
            <Image
        ...
        <div className="offer_dowm flex justify-evenly items-center mt-10 md:mt-16 flex-col-reverse md:flex-row gap-6 md:gap-0 ">
          ...
          <div className="offer_located flex items-center gap-4">
            <div className="text-end ">
              <h1 className="text-primaryColo text-xl md:text-3xl font-medium">
                صدى الرنين
              </h1>
              <h1 className="text-3xl font-light dark:text-white">
                اليمن - حضرموت - المكلا
