...
<div className='detials_coupons flex  px-4 py-1 items-center'>
  ...
  <p className='text-gray-400 font-bold text-xs md:text-xl'>20/21/2024 </p> <span><IoTimerSharp className='text-gray-400 text-xs md:text-xl' />
  </span>
  </div>
   </div>
...
<h1 className="text-center md:text-end text-2xl font-bold">شروط استخدام الكوبون</h1>

<div className="grid grid-cols-1 md:grid-cols-2 mt-5">
   <div>
   <h1 className="text-center text-2xl">hussein</h1>
   <h1 className="text-center text-2xl">hussein</h1>
   <h1 className="text-center text-2xl">hsdgfdsgfdg</h1>
 
   </div>
   <div className="mt-10 md:mt-0">
   <h1 className="text-center text-2xl">hussein</h1>
   <h1 className="text-center text-2xl">hussein</h1>
   <h1 className="text-center text-2xl">hussesdan</h1>
   </div>
</div>
