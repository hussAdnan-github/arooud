...
export default function CardAbout() {
  return (
    <div className="card_about">
        ...
        <div className="my-10 py-12 flex flex-col   bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full items-center  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="px-8 md:px-20 text-end flex flex-col items-center md:items-end  p-4 leading-normal">
                ...
                <p className="mb-3 text-[32px] font-light text-center md:text-end text-gray-600 dark:text-gray-400 ">حن صديق ساطع. مورد موثوق للادخار. أيقونة تضمن أنك ستحصل على قيمة أكبر مقابل نقودك. نجمع الناس مع العلامات التجارية التي تهتم بإضافة قيمة ومكافأة عملائها. نذهب إلى أبعد من ذلك بحثًا عن وفورات أكبر وعروض جديدة وطرق فريدة لمساعدتك في الاحتفاظ بأكبر قدر ممكن من المال في محفظتك.</p>
            </div>
        ...
        <div className=" my-10 py-12 flex items-center flex-col bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="px-8 md:px-20 text-center md:text-end flex flex-col items-center md:items-end  p-4 leading-normal">
                ...
                <p className="mb-3 text-[32px] font-light text-gray-600 dark:text-gray-400 ">حن صديق ساطع. مورد موثوق للادخار. أيقونة تضمن أنك ستحصل على قيمة أكبر مقابل نقودك. نجمع الناس مع العلامات التجارية التي تهتم بإضافة قيمة ومكافأة عملائها. نذهب إلى أبعد من ذلك بحثًا عن وفورات أكبر وعروض جديدة وطرق فريدة لمساعدتك في الاحتفاظ بأكبر قدر ممكن من المال في محفظتك.</p>
            </div>
        ...
        <div className=" my-10 items-center py-12 flex flex-col bg-white border border-gray-200 rounded-lg shadow md:flex-row md:max-w-full  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="px-8 md:px-20 text-center md:text-end flex flex-col items-center md:items-end  p-4 leading-normal">
