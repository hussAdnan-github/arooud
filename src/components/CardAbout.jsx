  ...
  return (
    <div className="card_about">
      ...
      */}
      ...
      {about.map((item) => (
        <div key={item.id}>
          <div className="my-10 lg:h-96 py-4 flex flex-col-reverse lg:justify-between  bg-white border border-gray-200 rounded-lg shadow lg:flex-row lg:w-full items-center  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700">
            <div className="px-8 md:px-20 text-end flex flex-col items-center md:items-end  p-4 leading-normal flex-1">
              ...
              <p className="mb-3 text-[32px] font-light text-center md:text-end  ">
                {item.goal_ar}
              </p>
            </div>
            <Image
