...
export default function CardProduct() {
  return (
    <div>
<div class="card relative m-10 flex w-full max-w-xs flex-col overflow-hidden rounded-lg border border-gray-100 bg-white shadow-md">
  <a class="relative mx-2 mt-2 flex h-60 overflow-hidden rounded-xl bg-gray-200" href="#">
    <Image class=" w-full" src={card} alt="product image" />
    <span class="absolute top-0 right-0" style={{right:'-14px'}}><Image src={iconCard}/></span>
  </a>
  <div class=" px-4 pb-5 card_body mt-1 text-end">
