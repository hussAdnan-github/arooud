...
//         </div>
//         <p className="description_partenrs text-3xl font-light	text-black dark:text-white">
...
//                 يرجى التواصل
//               </h1>
//               <h1 className="text-3xl font-light text-black dark:text-white	mt-2">+967 785×××××5</h1>
//             </div>
...
//               صدى الرنين
//             </h1>
//             <h1 className="text-3xl font-light text-black dark:text-white	mt-2">اليمن - حضرموت - المكلا</h1>
//           </div>
//           <IoLocationOutline className="text-primaryColo  text-4xl" />
//         </div>
//         <div className="bg-[#F4F4F4] dark:bg-primaryDark w-44 h-44 flex justify-center items-center rounded-lg">
