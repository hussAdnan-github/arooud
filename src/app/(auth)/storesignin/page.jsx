...
export default function page() {
  return (
   ...
   <Link href={'/storesignup'} type="submit" className="text-white md:w-[230px] bg-primaryColo transition ease-in-out delay-150 hover:-translate-y-1 hover:scale-105  duration-30 text-xl font-bold text-center inline-block w-60  rounded-full py-2">
   إضافة متجر جديد
    </Link >
